   ...
   while (true) {
      ...
      switch (cmd) {
         ...
         case '0' : // clear FPGA configuration register
            ...
            transmit_SPI(0x73, 0x00, 0x00 << 3);             // LMX: FSK_DEV_SCALE
            break;
         ...
         case '1' : // set FSK deviation scale
            transmit_SPI(0x73, 0x00, 0x01 << 3);             // LMX: FSK_DEV_SCALE
            break;

         case '2' : // set FSK deviation scale
            transmit_SPI(0x73, 0x00, 0x02 << 3);             // LMX: FSK_DEV_SCALE
            break;

         case '3' : // set FSK deviation scale
            transmit_SPI(0x73, 0x00, 0x03 << 3);             // LMX: FSK_DEV_SCALE
            break;
