...
/* Symbols to be used with PORT driver */
#define BOARD_ADC0_SE13_PORT PORTB               /*!<@brief PORT peripheral base pointer */
#define BOARD_ADC0_SE13_PIN 3U                   /*!<@brief PORT pin number */
#define BOARD_ADC0_SE13_PIN_MASK (1U << 3U)      /*!<@brief PORT pin mask */
                                                 /* @} */
